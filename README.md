...
# Syntaxe and rules:
Its a very intuitive language with 4 variables types (inputs/constants, simple functions, complex (or composed) functions, and output), and 5 operations (addition, subtraction, multiplication, division, comparation).
